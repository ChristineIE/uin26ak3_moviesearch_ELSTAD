...
export default function Home() {
  ...
  useEffect(() => {
    //Bekreftet med ChatGPT at useEffect skulle brukes her: https://chatgpt.com/share/69b6bcbf-6060-8006-9f84-cd5c234d02f4
  ...
  const getMovies = async () => {
    if (search.length < 3) return; //Rettet opp i liten skrivefeil her ved hjelp av ChatGPT. Fra ">" til "<". https://chatgpt.com/share/69b6bcbf-6060-8006-9f84-cd5c234d02f4
  ...
  return (
    <main>
      ...
      <section>
        <h2>Utvalgte filmer du kanskje liker</h2>
